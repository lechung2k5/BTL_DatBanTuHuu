-- =========================================
-- CƠ SỞ DỮ LIỆU NHÀ HÀNG TỨ HỮU (ĐÃ CHỈNH SỬA DỮ LIỆU MẪU)
-- =========================================
...
('KH001', N'Nguyễn Thị Hồng', '0912345678', 'hong.nguyen@example.com', '1998-06-12', N'Member'),
('KH002', N'Lê Văn Nam', '0987654321', 'nam.le@example.com', '2000-03-22', N'Gold'),
('KH003', N'Dương Gia Minh', '0933555777', 'minh.duong@example.com', '2002-11-05', N'Diamond');
GO
...
CREATE TABLE UuDai (
    ...
    moTa NVARCHAR(255),
    giaTri DECIMAL(18,2), -- % giảm giá, hoặc số tiền
    ngayBatDau DATE,
    ngayKetThuc DATE
);
GO
...
('MA001', N'Cơm chiên hải sản', NULL, 55000, 'DM001'), -- Món chính
('MA002', N'Bò lúc lắc khoai tây', NULL, 89000, 'DM001'), -- Món chính
('MA003', N'Súp bí đỏ kem tươi', NULL, 39000, 'DM002'), -- Món khai vị
('MA004', N'Trà đào cam sả', NULL, 29000, 'DM003'), -- Nước giải khát
('MA005', N'Bánh flan caramel', NULL, 25000, 'DM004'); -- Tráng miệng
GO
...
('B002', N'Tầng 1 - Khu lửng', 10, N'TANG_1', N'DangSuDung'), -- DangSuDung (Đã có khách ngồi)
('B003', N'Phòng VIP - Sảnh trong', 15, N'PHONG', N'DaDat'); -- DaDat (Đã đặt trước)
GO
...
CREATE TABLE HoaDon (
    ...
    trangThai NVARCHAR(20),
    gioVao DATETIME,
    gioRa DATETIME NULL, -- Có thể NULL nếu là HoaDonTam
    maBan VARCHAR(10),
    maNV VARCHAR(10),
...
('HD001', '2025-10-18 11:30', NULL, N'TienMat', N'HoaDonCuoi', '2025-10-18 10:45', '2025-10-18 11:40', 'B001', 'NV002', 'KH001'), -- Tổng tiền món: 168.000 (Khách Member, Không ưu đãi)
('HD002', '2025-10-18 20:15', 'UD001', N'NganHang', N'HoaDonTam', '2025-10-18 19:30', NULL, 'B002', 'NV003', 'KH002'); -- Tổng tiền món: 139.000 (Khách Gold, có mã ưu đãi nhưng chưa đủ điều kiện > 200.000 VND để áp dụng), HoaDonTam
GO

-- ==========================
-- BẢNG CHI TIẾT HÓA ĐƠN
-- thanhTien = soLuong * MonAn.giaBan
-- ==========================
...
-- HD001 (Tổng tiền món = 168.000)
INSERT INTO ChiTietHoaDon VALUES
('HD001', 'MA001', 2, 110000), -- Cơm chiên hải sản (55.000 * 2)
('HD001', 'MA004', 2, 58000),  -- Trà đào cam sả (29.000 * 2)
-- HD002 (Tổng tiền món = 139.000)
('HD002', 'MA002', 1, 89000),  -- Bò lúc lắc khoai tây (89.000 * 1)
('HD002', 'MA005', 2, 50000);  -- Bánh flan caramel (25.000 * 2)
GO