...
public class KhuyenMai {
	...
	@FXML
	private TableView<Promotion> tblKhuyenMai;
	@FXML
	private TableColumn<Promotion, String> colTenKM;
	@FXML
	private TableColumn<Promotion, String> colMaKM;
	@FXML
	private TableColumn<Promotion, String> colThoiGian;
	@FXML
	private TableColumn<Promotion, String> colTrangThai;
	@FXML
	private TableColumn<Promotion, Void> colHanhDong;
	...
	@FXML
	private Button btnThem, btnSua, btnLuu;
	...
	public void initialize() {
		...
		filterComboBox
				.setItems(FXCollections.observableArrayList("Tất cả", "Đang áp dụng", "Tạm ngưng", "Không áp dụng"));
	...
	private void loadSampleData() {
		...
		promotions.add(new Promotion("Giảm 10% cho đơn từ 200k", "KM10", LocalDate.of(2024, 4, 1),
				LocalDate.of(2024, 4, 30), "Đang áp dụng (combobox)"));
		promotions.add(new Promotion("Giảm 15% cho khách hàng có thẻ thành viên đã thanh toán trên 1.000.000 VNĐ",
				"TV15", LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 15), "Tạm ngưng"));
		promotions.add(new Promotion("Giảm 5% cho khách hàng có thẻ thành viên đã thanh toán trên 500.000 VNĐ", "TV05",
				LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 31), "Không áp dụng"));
		// *** ADDED MORE DATA TO SHOW SCROLLBAR ***
		promotions.add(new Promotion("Khuyến mãi 20/10", "PNVN", LocalDate.of(2024, 10, 15), LocalDate.of(2024, 10, 21),
				"Đang áp dụng"));
		promotions.add(new Promotion("Mừng Quốc Khánh 2/9", "QK0209", LocalDate.of(2024, 8, 30),
				LocalDate.of(2024, 9, 3), "Đã hết hạn"));
		promotions.add(new Promotion("Chào hè rực rỡ", "SUMMER24", LocalDate.of(2024, 6, 1), LocalDate.of(2024, 8, 31),
				"Tạm ngưng"));
		promotions.add(new Promotion("Black Friday Sale", "BF2024", LocalDate.of(2024, 11, 29),
				LocalDate.of(2024, 11, 29), "Sắp diễn ra"));
