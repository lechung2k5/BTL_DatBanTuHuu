...
public class HoaDon {
    ...
    public HoaDon(String maHoaDon, LocalDate ngayLap, String hinhThucTT, String maKhachHang, String thuNgan, int ban, LocalTime gioVao, LocalTime gioRa, double tongCongMonAn, double phiDichVu, double thueVAT, double tienDatCoc, double khuyenMai, double tongTienThanhToan) {
    ...
    public String getThuNgan() { return thuNgan; }
    ...
    @FXML private TableColumn<HoaDon, String> colHinhThucThanhToan;
    ...
    @FXML private TableView<?> tableChiTietHD;
    ...
    private void initialize() {
        danhSachHoaDon = FXCollections.observableArrayList(
            new HoaDon("HD00036", LocalDate.of(2025, 10, 26), "Tiền mặt", "0377019955", "Trần Hoàng Nam", 16, LocalTime.of(18, 0), LocalTime.of(21, 0), 520000, 26000, 41600, -150000, -130000, 437600),
            new HoaDon("HD00002", LocalDate.of(2025, 10, 15), "Chuyển khoản", "0912345678", "Nguyễn Văn A", 5, LocalTime.of(19, 30), LocalTime.of(20, 45), 350000, 17500, 28000, -100000, 0, 295500),
            new HoaDon("HD00003", LocalDate.of(2025, 10, 14), "Tiền mặt", "0978456123", "Lê Thị B", 8, LocalTime.of(11, 0), LocalTime.of(12, 15), 150000, 7500, 12000, 0, -20000, 149500)
        );

        colMaHD.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getMaHoaDon()));
        colNgay.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getNgayLap().format(dateFormatter)));
