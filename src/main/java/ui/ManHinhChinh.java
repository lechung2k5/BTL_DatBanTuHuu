...
public class ManHinhChinh {
	...
	@FXML
	private Label userNameLabel; // Đã có fx:id
	@FXML
	private Label userRoleLabel; // Đã có fx:id
	@FXML
	private ImageView profileImage; // Đã có fx:id
	...
	private void handleDangXuat() {
		...
		if (mainApp != null) {
			...
			// Cần sửa lại MainApp.start và MainApp.gotoLogin để xử lý primaryStage đúng
			// cách
