...
public class ThucDon {
	...
	@FXML
	private TableView<MenuItem> tableThucDon;
	@FXML
	private TableColumn<MenuItem, String> colTenMon;
	@FXML
	private TableColumn<MenuItem, Image> colHinhAnh;
	@FXML
	private TableColumn<MenuItem, Number> colDonGia;

	@FXML
	private TextField txtTenMon, txtDonGia, txtSearch;
	@FXML
	...
	@FXML
	private TextField txtDanhMuc;

	@FXML
	private Button btnThem, btnXoa, btnSua, btnXoaTrang;
	@FXML
	private Button btnLuuForm;
	@FXML
	private Button btnTim; // Nút này giờ sẽ có chức năng

	@FXML
	private HBox categoryButtonBox;
	@FXML
	private Button btnKhaiVi, btnNuong, btnLau, btnXaoHap, btnChien, btnDacSan, btnDoUong;

	@FXML
	private AnchorPane formInputArea;
	...
	private void populateTable(ArrayList<MonAn> listFromDB) {
		...
		for (MonAn monAn : listFromDB) {
			...
			MenuItem itemUI = new MenuItem(monAn.getMaMon(), monAn.getTenMon(), fxImage, monAn.getGiaBan(),
					monAn.getTenDanhMuc(), monAn.getMaDM());
	...
	// (Hàm handleLuuForm, handleXoaMonAn, onUploadClicked, clearForm, showAlert,
	// setupTableColumns giữ nguyên)
	...
	public static class MenuItem {
		...
		public SimpleStringProperty maDMProperty() {
			return maDM;
		}
	}
}