...
public class QuenMatKhau {
	...
	@FXML
	private PasswordField pfMatKhauMoi; // Thêm khai báo
	@FXML
	private PasswordField pfXacNhanMatKhau; // Thêm khai báo
	@FXML
	private Button btnXacNhanMaNV; // Nút kiểm tra mã
	@FXML
	private Button btnDoiMatKhau; // Nút đổi mật khẩu
	@FXML
	private HBox hboxMatKhauMoi; // HBox chứa ô MK mới
	@FXML
	private HBox hboxXacNhanMK; // HBox chứa ô xác nhận MK
