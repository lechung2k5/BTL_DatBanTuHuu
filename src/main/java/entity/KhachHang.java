...
public class KhachHang {
	...
	public KhachHang(String maKH, String tenKH, String soDT, String email, LocalDate ngayDangKy, String diaChi,
			String thanhVien) {
		this.maKH = maKH;
		this.tenKH = tenKH;
		this.soDT = soDT;
	...
	/*
	 * public LocalDate getNgaySinh() { return ngaySinh; } public void
	 * setNgaySinh(LocalDate ngaySinh) { this.ngaySinh = ngaySinh; }
	 */
