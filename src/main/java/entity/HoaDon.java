...
/**
 * Lớp Entity (Model) đại diện cho đối tượng Hóa Đơn. Đã cập nhật hoàn chỉnh để
 * đồng bộ với các DAO và Controller.
 */
public class HoaDon {
	...
	private KhachHang khachHang; // Dùng đối tượng KhachHang
	private String tenNhanVien; // Giữ lại tên NV vì DAO có join lấy tên
	private Ban ban; // Dùng đối tượng Ban
	private LocalDateTime gioVao;
	private LocalDateTime gioRa;
	private double tongCongMonAn; // Giữ lại vì DAO có subquery tính
	...
	// Hàm tính toán tổng tiền (có thể gọi lại khi thêm/bớt món hoặc cập nhật ưu
	// đãi)
	public void calculateTotals() {
		...
		// TODO: Cần logic phức tạp hơn để tính khuyến mãi dựa trên maUuDai và tổng tiền
		// món
		this.khuyenMai = 0.0;
	...
	public PTTThanhToan getHinhThucTT() {
		return hinhThucTT;
	}
	...
	public void setHinhThucTT(PTTThanhToan hinhThucTT) {
