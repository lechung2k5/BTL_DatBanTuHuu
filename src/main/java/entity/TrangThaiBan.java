...
/**
 * Enum đại diện cho các Trạng Thái Bàn. Đã cập nhật để đồng bộ với các DAO và
 * Controller.
 */
public enum TrangThaiBan {
	TRONG("Trong", "Trống"), // dbValue, displayName
	DANG_SU_DUNG("DangSuDung", "Đang sử dụng"), DA_DAT("Dat", "Đã đặt"); // Sử dụng "Dat" làm dbValue khớp với script
																			// SQL INSERT
	...
	/**
	 * Lấy giá trị được lưu trữ trong cơ sở dữ liệu (ví dụ: "Trong", "DangSuDung",
	 * "Dat").
	 * 
	...
	/**
	 * Lấy tên hiển thị thân thiện trên giao diện (ví dụ: "Trống", "Đang sử dụng",
	 * "Đã đặt").
	 * 
	 ...
	 * @return Enum TrangThaiBan tương ứng, mặc định là TRONG nếu không khớp hoặc
	 *         null.
	 */
	public static TrangThaiBan fromDbValue(String dbValue) {
		...
		default:
			System.err.println(
					"WARNING: Giá trị TrangThaiBan không xác định từ DB: '" + dbValue + "'. Mặc định thành TRONG.");
