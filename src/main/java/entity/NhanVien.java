...
public class NhanVien {
	...
	public void setCaLam(String caLam) {
		this.caLam.set(caLam);
	}

	public StringProperty caLamProperty() {
		return caLam;
	}

	// 🔥 Ca làm YÊU THÍCH (MỚI - Lấy từ CSDL NhanVien)
	public String getCaLamYeuThich() {
		return caLamYeuThich.get();
	}
	...
	public StringProperty caLamYeuThichProperty() {
		return caLamYeuThich;
	}

	// Getters cho DAO sử dụng
	public String getTenNV_entity() {
		return tenNV_entity;
	}

	public String getSoDT_entity() {
		return soDT_entity;
	}

	public String getEmail_entity() {
		return email_entity;
	}

	public LocalDate getNgaySinh_entity() {
		return ngaySinh_entity;
	}

	public String getDiaChi_entity() {
		return diaChi_entity;
	}

	public boolean getGioiTinh_entity() {
		return gioiTinh_entity;
	}

	public boolean getTrangThai_entity() {
		return trangThai_entity;
	}

	public String getCaLamYeuThich_entity() {
		return caLamYeuThich_entity;
	} // 🔥 Getter MỚI
