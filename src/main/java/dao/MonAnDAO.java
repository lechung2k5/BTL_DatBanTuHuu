...
public class MonAnDAO {
	...
	public ArrayList<MonAn> getAllMonAn() {
		...
		String sql = "SELECT m.maMon, m.tenMon, m.hinhAnh, m.giaBan, m.maDM, d.tenDM " + "FROM MonAn m "
	...
	public ArrayList<MonAn> getMonAnByDanhMuc(String maDanhMuc) {
		...
		String sql = "SELECT m.maMon, m.tenMon, m.hinhAnh, m.giaBan, m.maDM, d.tenDM " + "FROM MonAn m "
				+ "LEFT JOIN DanhMucMon d ON m.maDM = d.maDM " + "WHERE m.maDM = ?";
	...
	public ArrayList<MonAn> searchMonAnByName(String tenMon) {
		...
		String sql = "SELECT m.maMon, m.tenMon, m.hinhAnh, m.giaBan, m.maDM, d.tenDM " + "FROM MonAn m "
				+ "LEFT JOIN DanhMucMon d ON m.maDM = d.maDM " + "WHERE m.tenMon LIKE ?"; // Dùng N' ngoài
																							// PreparedStatement
