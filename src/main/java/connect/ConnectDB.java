...
public class ConnectDB {
	...
	/**
	 * Phương thức này giờ sẽ tạo và trả về một KẾT NỐI MỚI mỗi khi được gọi. Nó
	 * không còn quản lý một biến 'connection' tĩnh nữa.
	 * 
	...
	/**
	 * Phương thức này không còn cần thiết vì 'try-with-resources' trong các lớp DAO
